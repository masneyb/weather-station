...
"${YADL_BIN}" --gpio_pin 3 --sensor dht22 --temperature_unit fahrenheit --max_retries 30 --output rrd --outfile "${WEB_BASE_DIR}"/temperature_humidity.rrd --output single_json --outfile "${WEB_BASE_DIR}"/temperature_humidity.json
