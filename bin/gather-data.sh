...
"${YADL_BIN}" --gpio_pin 3 --sensor dht11 --temperature_unit fahrenheit --output rrd --outfile "${WEB_DIR}"/temperature_humidity.rrd --output single_json --outfile "${WEB_DIR}"/temperature_humidity.json
